...
class CommonTruthSelectionModule : public Module
{
 ...
 private:
  ...
  bool vbfJetSel(xAOD::TruthParticle* par);
  ...
  bool isoSel(xAOD::TruthParticle* par);
  ...
  double leadLepCut(const std::string& key, double pTcut);
  ...
  std::vector<const xAOD::TruthParticle*> m_vbfQuarks; //!
